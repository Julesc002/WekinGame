...
public class CategoryControllerTest {
    ...
    public void testGetEntriesByCategoryAndWiki() {
        ...
        entryMock.when(() -> EntryRepository.getEntriesByWikiAndCategory(Integer.parseInt(idWiki), categoryName))
    ...
    public void deleteCategory() {
        ...
        // THEN
        wikiMock.verify(() -> WikiRepository.deleteCategory(Integer.parseInt(idWiki), givenCategoryName),
                Mockito.times(1));
    }
    ...
    public void testmodifyCategoryName() {
        ...
        entryMock.when(
                () -> EntryRepository.modifyCategoriesNameForEntries((String) givenOldCategoryName.get("categories"),
                        (Integer) givenOldCategoryName.get("id"), setQuery))
                .thenReturn(response);
